...
Pod::Spec.new do |spec|
  ...
  spec.description  = 'Description to descripe about the pod created'
  ...
  spec.author             = { "Pradeep N." => "pradeepn@nousinfo.com" }
  ...
  spec.source       = { :git => "https://github.com/NousPradeepN/RWPodSpecs.git", :tag => "#{spec.version}" }
